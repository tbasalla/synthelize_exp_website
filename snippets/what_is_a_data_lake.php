...
<div class="container">
        <div class="row">
            ...
            <p class="blog-p">At its root a data lake is nothing more than a highly scalable and performant raw data store where data can be staged.  What you do with that data is up to you.</p>
            <p class="blog-p">The following are some of the differences between data lakes and more traditional data warehouses:</p>
            <table style="border: 1px solid black; border-collapse: collapse">
                <tr >
                    <td style="border: 1px solid black; text-align: center" class="blog-p"><b>Data Warehouse</b></td>
                    <td style="border: 1px solid black; text-align: center" class="blog-p"><b>Data Lake</b></td>
                </tr>
                <tr>
                    <td style="border: 1px solid black" class="blog-p">Data is usually highly structured in nature and exists in the form of rows and columns.</td>
                    <td style="border: 1px solid black" class="blog-p">Data does not need to be highly structured and can exist in any raw format.</td>
                </tr>
                <tr>
                    <td style="border: 1px solid black" class="blog-p">Elaborate Extract/Transform/Load (ETL) procedures are developed to move data into the data warehouse.</td>
                    <td style="border: 1px solid black" class="blog-p">Data storage is as simple as writing files to disk.</td>
                </tr>
                <tr>
                    <td style="border: 1px solid black" class="blog-p">Data is structured with a particular end application (usually analytics) in mind.</td>
                    <td style="border: 1px solid black" class="blog-p">Data can be massaged into other formats and exported for many different kinds of use cases.</td>
                </tr>
                <tr>
                    <td style="border: 1px solid black" class="blog-p">The back-end storage of the data warehouse often necessitates a commitment to a particular database vendor.</td>
                    <td style="border: 1px solid black" class="blog-p">The back-end is usually simple disk storage and can be moved from one place to another.</td>
                </tr>
                <tr>
                    <td style="border: 1px solid black" class="blog-p">Data warehouses often have difficulty scaling beyond a certain size.</td>
                    <td style="border: 1px solid black" class="blog-p">Scale is only limited to available storage space.</td>
                </tr>
            </table>
            <br/>
            <h4 class="blog-subtitle">What makes a great data lake?</h4>
            <p class="blog-p">Data lake implementation details can vary.  Some lakes are implemented on premises.  In recent years organizations have started to shift toward cloud-based data lakes.  Regardless of the implementation details, well-architected data lakes share a number of characteristics.</p>
            <p class="blog-p"><b>Scalable</b> – There is not much point in creating a data lake if your data storage solution is not highly scalable.  Data lakes can grow to petabytes and even exabytes in size depending on your storage needs.  Cloud vendors have for the most part solved this problem by offering access to virtually unlimited storage.  On premises data lakes will have to deal with this problem by acquiring extensive NAS storage.</p>
            <p class="blog-p"><b>Available</b> – This means that the data lake can be accessed by all the people and applications that need to use it –whether for writing data for storage or reading data for analytics or other uses.  Cloud vendors solve this problem through partitioning and access roles.  On premises solutions will involve similar provisioning of network/storage access.</p>
            <p class="blog-p"><b>Performant</b> – Because of the amount of data being ingested, data lake storage needs to be highly performant, both from the network access perspective and the actual disk storage perspective.  This is one area where on-premises storage perhaps has an advantage over cloud storage.  Internal network connections are often much faster and offer far lower latency than the external network connections required to move data to the cloud.  Some of this difference is mitigated if many of your “data generating applications” already exist in cloud infrastructure.  Flexibility in disk storage is an advantage of  cloud providers – plans exist where you can direct your “freshest” data to highly responsive data stores, and as data ages, it can be archived to slower, lower-priority (and less expensive) storage.</p>
